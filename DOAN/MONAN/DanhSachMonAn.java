        ...
        do {
            ...
            switch (c) {
                ...
                case 2: {
                    ...
                    while (input == -1) {
                        input = checkLoi.checkSo(sc.next());
                    }
                    themMonAnOViTriK(input);
                    break;
                }
                ///

            }
            System.out.println("Nhập 0 de dung them Mon An hoac bat ky de tiep tuc");
        ...
        do {
            do {
                ...
                switch (number) {
                    ...
                    case 2: {
                        if (!check) {
                            System.out.println("Ban chua them mon");
                            break;
                        }
                        try {
